        ...
        <div className="max-w-7xl mx-auto px-4 py-3 relative">
          <div className="flex items-center justify-between gap-4">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-white font-medium">
              ...
              {['Home', 'Products', 'Coupons'].map((item) => (
                <a
                  key={item}
                  href="#"
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <div className={` overflow-hidden transition-all duration-500 ease-in-out ${isSearchOpen ? "w-64 opacity-100 mr-2" : "w-0 opacity-0"}`}>
                <input
                  type="text"
    ...
    <div className="relative bg-gradient-to-r from-purple-800 to-purple-900 text-white py-2 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between text-xs md:text-sm gap-2">
        <div className="flex items-center gap-1 overflow-hidden">
          <span className="font-medium whitespace-nowrap animate-slide-in-left">Welcome to SEVAFAST</span>
        </div>
        <div className="flex flex-wrap items-center gap-3 md:gap-6">
          <a href="mailto:info@sevafast.in" className="flex items-center gap-1.5 hover:text-green-300 transition-colors animate-slide-in-right animation-delay-200">
            <Mail className="w-3.5 h-3.5 md:w-4 md:h-4" />
            <span className="hidden sm:inline whitespace-nowrap">info@sevafast.in</span>
          </a>
          <div className="flex items-center gap-1.5 animate-slide-in-right animation-delay-400">
            <MapPin className="w-3.5 h-3.5 md:w-4 md:h-4" />
            <span className="hidden md:inline text-xs whitespace-nowrap">Shop No. Gvhsns raod New Mondha Parbhani, Parbhani, MH, 431401</span>
            <span className="md:hidden text-xs whitespace-nowrap">Parbhani, MH</span>
          </div>
        </div>
      </div>
      <style jsx>{`
