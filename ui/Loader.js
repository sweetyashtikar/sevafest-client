  ...
  return (
    ...
    >
      <div className="relative w-16 h-16">
        ...
        <div className="absolute inset-0 border-4 border-[#1a1c24] rounded-full border-t-transparent animate-spin shadow-[0_0_15px_rgba(250,204,21,0.2)]"></div>
      ...
      <div className="mt-8 flex flex-col items-center gap-3">
        <h2 className="text-[#1a1c24] font-black italic tracking-[0.5em] text-xs sm:text-sm animate-pulse">
          {text}
        </h2>

        <div className="w-20 h-[2px] bg-white/10 overflow-hidden relative rounded-full">
          <div className="absolute inset-0 bg-[#1a1c24] animate-loading-bar"></div>
        </div>
      </div>
